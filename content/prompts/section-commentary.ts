...
- When document pages are provided, include at least one pageCitation per section that uses qualitative colour: give the exact pageRef and a short (10-300 char) verbatim quote copied from that page's text — never paraphrase the quote.
